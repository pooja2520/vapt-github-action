...
async function run() {
    try {
        ...
        let jobId = '';
        try {
            const startRes = await axios_1.default.post(`${vaptUrl}/api/ci/code-scan/start`, {
                source: target,
        ...
        while (true) {
            ...
            try {
                const statusRes = await axios_1.default.get(`${vaptUrl}/api/ci/code-scan/status/${jobId}`, { headers, timeout: 30000 });
        ...
        const resultRes = await axios_1.default.get(`${vaptUrl}/api/ci/code-scan/result/${jobId}`, { headers, timeout: 30000 });
        ...
        try {
            ...
            const htmlRes = await axios_1.default.get(`${vaptUrl}/api/ci/code-scan/report/${jobId}/html`, {
                headers,
    ...
    `;
            ...
            const excelRes = await axios_1.default.get(`${vaptUrl}/api/ci/code-scan/report/${jobId}/excel`, {
                headers,
                params: { repo_name: repoName, branch: branch, build_id: buildId },
                responseType: 'arraybuffer',
                timeout: 30000
